...
1. Checkpoints can be downloaded from https://drive.google.com/file/d/1JS2i2_gEUay3ZidDcMOO36EIkgkMBuz2/view?usp=sharing . They should be placed at the `./saved_model` folder.
